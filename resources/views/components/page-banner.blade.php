@if (!empty($hero))
    @php
        ...
        $wrapper_classes = [
            ...
            'center' =>
                'custom-banner about-banner text-white flex items-center justify-center p-page-x relative overflow-hidden h-screen-without-header md:h-[622px] lg:h-screen-without-header',
        ];
        ...
        >
            ...
            <div class="relative z-20">
                @if ($heading)
                    <h1
                        data-aos="fade-in"
                        class="{{ $title_classes[$layout_type] }}"
                    >
                        {!! $heading !!}
                    </h1>
                @endif
                ...
                @if ($desc)
                    <div
                        data-aos="fade-in"
                        class="{{ $desc_classes[$layout_type] }}"
                    >
                        {!! $desc !!}
                    </div>
                @endif
