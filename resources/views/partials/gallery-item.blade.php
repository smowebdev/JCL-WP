...
@if (is_array($image) && !empty($image['url']))
    <a
        {{ $attributes->merge(['data-gallery' => $data_gallery]) }}
        href="{{ $image['url'] }}"
        class="glightbox group relative overflow-hidden cursor-pointer project-image lg:min-w-[270px] lg:h-[180px] lg:w-[270px] sm:h-[29.75vw]"
    >
        <img
